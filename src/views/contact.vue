<template>
    <section class="h-auto abs-center flex-col py-[5rem]" id="contact">
        <h1 class="font-rowdie font-bold text-[2em] section-title">Contact</h1>
        <div class="abs-center gap-2 w-full mt-10">
            <div class="w-[50%] abs-center">
               <div class="flex flex-col gap-4">
                    <div class="flex gap-1 border-2 border-[#393E46] bg-c-00ADB5-trans skew-x-[-10deg] rounded-md px-4 py-1" data-aos="fade-right">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-map-pin"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
                        <i>Poblacion Tampakan South Cotabato</i>
                    </div>
                    <div class="flex gap-1 border-2 border-[#393E46] bg-c-00ADB5-trans skew-x-[-10deg] rounded-md px-4 py-1" data-aos="fade-right">
                    ...
                    <div class="flex gap-1 border-2 border-[#393E46] bg-c-00ADB5-trans skew-x-[-10deg] rounded-md px-4 py-1" data-aos="fade-right">
                        ...
                        <i>dong.asumbra@gmail.com</i>
                    </div>
                    <div class="flex gap-1 border-2 border-[#393E46] bg-c-00ADB5-trans skew-x-[-10deg] rounded-md px-4 py-1" data-aos="fade-right">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                        <i>xchitts@gmail.com</i>
                    </div>
               </div>
            </div>
